...
{
    private static $VISTA_CONSULTAR = 'respaldo';
    ...
    public function respaldo(){
        ...
        $db_name = 'Sistema_tutorias'; //Nombre de la Base de datos
        ...
        //Comando para genera respaldo de MySQL, enviamos las variales de conexion y el destino C:\xampp\mysql\bin
        $dump = 'C:\xampp\mysql\bin\mysqldump --no-defaults --user='.$db_user.' --password='.$db_pass.' --host='.$db_host.' '.$db_name.' > '.$salida_sql.'';
