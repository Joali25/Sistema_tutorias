...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Consultar Administradores</strong>
            <a href="./?vista=nuevoAdmin" class="float-right btn btn-dark btn-sm">
                <i class="fa fa-fw fa-plus-circle"></i> Agregar Administrador
            </a>
        </div>
    </div>
    <hr>
        ...
        <table class="table table-striped table-bordered">
            ...
            if (count($objs) > 0) {
                foreach ($objs as $obj) {
                    ?>
                    <tr>
                        <td align="center"><?=$obj->Matricula?></td>
                        <td align="center"><?=$obj->Nombre?></td>
                        <td align="center"><?=$obj->ApellidoP?></td>
                        <td align="center"><?=$obj->ApellidoM?></td>
                        <td align="center">
                            <a href="./?vista=editarUsuario&id=<?=$obj->Matricula?>" class="text-primary"><i
                                    class="fa fa-fw fa-edit"></i> Editar</a>
                        </td>
                        <td align="center">
                            <a href="./?vista=eliminarUsuario&id=<?=$obj->Matricula?>" class="text-danger"
