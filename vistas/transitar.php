...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Transitar de cuatrimestre</strong>
        </div>
    </div>
    <hr>
    
    <form method="post" enctype="multipart/form-data" action="./?vista=transitarCuatrimestre">
        <div class="form-group">
            <h5 >Se requiere que se indique cual será el nuevo grupo para el siguiente periodo al que se transita.</h5>
            <table class="table table-striped table-bordered">
                ...
                <tr class="bg-primary text-white">
                    ...
                    <th class="text-center">Nuevo Grado</th>
                    <th class="text-center">Nuevo Grupo</th>
                </tr>
                </thead>
                <tbody>
                <?php
                if (count($Periodos) > 0) {
                    ...
                    foreach ($Periodos as $Periodo) {
                        ...
                        ?>
                        <tr>
                            <td align="center"><?=$Periodo->IdPeriodo?></td>
                            <td align="center"><?=$Periodo->Grado?></td>
                            <td align="center"><?=$Periodo->Grupo?></td>
                            <td align="center"><input type="number" min="1" max="9" name="<?=$k?>" id="<?=$k?>"  class="form-control" required></td>
        ...
        <div class="form-group">
            <h5 >Se requiere que se indique cual será el nuevo grupo para cada tutor</h5>
            <table class="table table-striped table-bordered">
                <thead>
                <tr class="bg-primary text-white">
                ...
                if (count($Tutores) > 0) {
                    foreach ($Tutores as $Tutor) {
                        ...
                        ?>
                        <tr>
                            <td align="center"><?=$Tutor->Matricula?></td>
                            <td align="center"><?=$Tutor->Nombre?> <?=$Tutor->ApellidoP?> <?=$Tutor->ApellidoM?></td>
                            <td align="center"><input type="number" min="1" max="9" name="<?=$k?>" id="<?=$k?>"  class="form-control"></td>
                            <td align="center"><input type="text" name="<?=$l?>" id="<?=$l?>"  class="form-control"></td>
                        </tr>
                        <?php
                    }
                } else {
        ...
        <div class="form-group" align="center">
            ...
            <i class="fa fa-fw fa-arrow-right"></i> Transitar
            </button>
        </div>
    </form>
