...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="./?vista=verCitas" class="float-right btn btn-dark btn-sm">
                <i class="fa fa-fw fa-arrow-left"></i> Ver Citas
            </a>
        </div>
        ...
        <div class="card-body">
            <div class="col-sm-6">
                ...
                <form method="post" enctype="multipart/form-data" action="./?vista=confirmarAsistenciaAlumno">
                    <input type="hidden" name="id" id="id" value="<?=$idCita?>">
                    <div class="form-group">
                        <label>¿El alumno asistió a la tutoría? <span class="text-danger">*</span></label>
                        <label><input type="radio" id="estatus" name="estatus" value="1" checked>SI</label>
                        <label><input type="radio" id="estatus" name="estatus" value="0" >NO</label>
                    </div>
                    <div class="form-group">
