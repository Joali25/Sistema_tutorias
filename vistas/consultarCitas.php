...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Citas previas</strong>
            <a href="./?vista=agendar" class="float-right btn btn-dark btn-sm">
                <i class="fa fa-fw fa-calendar-week"></i> Volver al calendario
            </a>
        </div>
    </div>
    <hr>
        ...
        <table class="table table-striped table-bordered">
            ...
            if ( $cant > 0) {
                for($i=0; $i<$cant;$i++) {
                    ?>
                    <tr>
                        <td align="center"><?=$ids1[$i]?></td>
                        <td align="center"><?=$previas[$i]?></td>
                        <td align="center"><?=$horarios1[$i]?></td>
                        <td align="center"><?=$nombres1[$i]?></td>
                        <td align="center">
                            <a href="./?vista=verRegistro&id=<?=$ids1[$i]?>" class="text-primary"><i
                                    class="fa fa-fw fa-edit"></i> Ver Registro </a>
                        </td>
                    </tr>
                    <?php
                }
        ...
        <table class="table table-striped table-bordered">
            ...
            if ( $cant > 0) {
                for($i=0; $i<$cant;$i++) {
                    ?>
                    <tr>
                        <td align="center"><?=$ids2[$i]?></td>
                        <td align="center"><?=$hoy[$i]?></td>
                        <td align="center"><?=$horarios2[$i]?></td>
                        <td align="center"><?=$nombres2[$i]?></td>
                        <?php
                        if ($contestados[$i]==0){
                        ?>
                        <td align="center">
                            <a href="./?vista=confirmarAsistencia&id=<?=$ids2[$i]?>" class="text-primary"><i
                                    class="fa fa-fw fa-edit"></i> Verificar Asistencia </a>
                        </td>
                        <?php
                        }else{
                        ?>
                        <td align="center">
                            <a href="./?vista=verRegistro&id=<?=$ids2[$i]?>" class="text-primary"><i
                                    class="fa fa-fw fa-edit"></i> Ver Registro </a>
                        </td>
                        <?php
                        }
        ...
        <table class="table table-striped table-bordered">
            ...
            if ( $cant > 0) {
                for($i=0; $i<$cant;$i++) {
                    ?>
                    <tr>
                        <td align="center"><?=$ids3[$i]?></td>
                        <td align="center"><?=$futuras[$i]?></td>
                        <td align="center"><?=$horarios3[$i]?></td>
                        <td align="center"><?=$nombres3[$i]?></td>
                    </tr>
                    <?php
                }
            } else {
