    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="./?vista=verCitas" class="float-right btn btn-dark btn-sm">
                <i class="fa fa-fw fa-book"></i> Ver Citas
            </a>
        </div>
    </div>
    <hr>
                        ...
                        if($day<=$diaActual || $i%7==0 || ($i+1)%7==0){
                            ...
                            if(($i+6)%7==0){
                                if($citas[0]==0){
                                    ...
                                    //Se pinta verde
                                    if($reservas[$day]==0){
                                        echo "<td style='background-color: #78FA56'><a href='./?vista=agendar2&id=$day' class='text-primary'>$day</a></td>";
                                    }
                                    if($citas[0]>$reservas[$day] && $reservas[$day]>0){
                                        echo "<td style='background-color: #FDF159'><a href='./?vista=agendar2&id=$day' class='text-primary'>$day</a></td>";
                                    }
