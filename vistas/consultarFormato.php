...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Consultar Campos del formato de tutorías</strong>
            <a href="./?vista=nuevoFormato" class="float-right btn btn-dark btn-sm">
            ...
            if (count($objs) > 0) {
                foreach ($objs as $obj) {
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="./?vista=editarFormato&id=<?=$obj->Id?>" class="text-primary"><i
