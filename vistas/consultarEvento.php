...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="./?vista=nuevoEvento" class="float-right btn btn-dark btn-sm">
        ...
        <table class="table table-striped table-bordered">
            ...
            if (count($objs) > 0) {
                foreach ($objs as $obj) {
                    ?>
                    <tr>
                        <td align="center"><?=$obj->IdEvento?></td>
                        <td align="center"><?=$obj->Nombre?></td>
                        <td align="center">
                            <a href="./?vista=editarEvento&id=<?=$obj->IdEvento?>" class="text-primary"><i
                                    class="fa fa-fw fa-edit"></i> Editar</a>
                        </td>
                        <td align="center">
                            <a href="./?vista=eliminarEvento&id=<?=$obj->IdEvento?>" class="text-danger"
