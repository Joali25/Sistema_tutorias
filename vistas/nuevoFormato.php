...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="./?vista=consultarEvento" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i>Consultar Campo</a>
        </div>

        <div class="card-body">
            <div class="col-sm-6">
                <h5 class="card-title">¡Los campos con <span class="text-danger">*</span> son obligatorios!</h5>
                <form method="post" enctype="multipart/form-data" action="./?vista=agregarFormato">
                    <div class="form-group">
                        <label>CAMPO: <span class="text-danger">*</span></label>
                        <input type="text" name="campo" id="campo" class="form-control" placeholder="Ingresa el nombre para el campo" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary">
                            <i class="fa fa-fw fa-plus-circle"></i> Agregar Campo
                        </button>
                    </div>
                </form>
            </div>
