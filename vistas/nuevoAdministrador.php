...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="./?vista=consultarAdmin" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i>Consultar Administradores</a>
        </div>

        <div class="card-body">
            <div class="col-sm-6">
                <h5 class="card-title">¡Los campos con <span class="text-danger">*</span> son obligatorios!</h5>
                <form method="post" enctype="multipart/form-data" action="./?vista=agregarUsuario">
