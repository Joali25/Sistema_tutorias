                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="./?vista=reporteTutorias">Tutorías por Rangos</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="./?vista=tutoriasTotales">Tutorías totales</a>
                            </div>
                        </li>
                        <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                            class="nav-item">
...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <strong class="text-center">BIENVENIDO ADMINISTRADOR AL SISTEMA PARA TUTORÍAS</strong>
                        ...
                        <?php
                            ...
                            if (count($objs) > 0) {
                                foreach ($objs as $sliderImage) {
                                    ...
                                    $sliderHtml.= "<div class='col-xs-4'><a href='".$sliderImage['IdEvento']."'>";
                                    $sliderHtml.= "<a href='".$sliderImage['Url']."'><img width='400' height='400' src='vistas/Imagenes/".$sliderImage['Ruta']."' lass='img-responsive'></a>";
