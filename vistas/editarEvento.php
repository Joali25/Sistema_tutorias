    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-sm-6">
                ...
                <form method="post" enctype="multipart/form-data" action="./?vista=guardarEvento">
                    <input type="hidden" name="id" id="id" value="<?=$obj->IdEvento?>">
                    <div class="form-group">
                        <label>NOMBRE: <span class="text-danger">*</span></label>
                        <input type="text" name="nombre" value="<?=$obj->Nombre?>" id="nombre" class="form-control" placeholder="Ingresa el nombre" required>
                    </div>

                    <div class="form-group">
                        <label>IMAGEN: <span class="text-danger"></span></label>
                        <input type="file" name="imagen" id="imagen" accept="image/jpg, image/jpeg">
                    </div>
                    
                    <div class="form-group">
                        <label>URL: <span class="text-danger">*</span></label>
                        <input type="text" name="url" value="<?=$obj->Url?>" id="url" class="form-control" placeholder="Ingresa el Url" required>
                    </div>
