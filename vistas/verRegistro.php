...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Registro de tutoría</strong>
        ...
        <div class="card-body">
            <div class="col-sm-6">
                ...
                <label><?=$cita->Fecha?></label>
                <br>
                <span class="badge badge-info">HORA:</span> 
                <label><?=$hora->Horario?></label>
                <br>
                ...
                if($cant>0){
                    for($i=0; $i<$cant;$i++) {?>
                        <span class="badge badge-info"><?=$preguntas[$i]?> :</span>
                        <label><?=$respuestas[$i]?> </label><br>
                    <?php
                    }
                }else{
                ?>
                    <h2><span class="badge badge-danger">NO SE TIENE REGISTRO DE LA TUTORÍA</span></h2>
