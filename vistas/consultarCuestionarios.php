...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="./?vista=nuevoCuestionario" class="float-right btn btn-dark btn-sm">
            ...
            if (count($objs) > 0) {
                foreach ($objs as $obj) {
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="./?vista=editarCuestionario&id=<?=$obj->Id?>" class="text-primary"><i
                ...
                ?>
                <tr><td colspan="4" align="center">No hay nada registrado</td></tr>
                <?php
            }
            ?>
            </tbody>
