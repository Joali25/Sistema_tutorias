...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="./?vista=nuevoAlumno" class="float-right btn btn-dark btn-sm">
                <i class="fa fa-fw fa-plus-circle"></i> Agregar alumno
            </a>
        </div>
    </div>
    <hr>
        ...
        <table class="table table-striped table-bordered">
            ...
            if ( $cant > 0) {
                for($i=0; $i<$cant;$i++) {
                    ?>
                    <tr>
                        <td align="center"><?=$mat[$i]?></td>
                        <td align="center"><?=$nombre[$i]?></td>
                        <td align="center"><?=$AP[$i]?></td>
                        <td align="center"><?=$AM[$i]?></td> 
                        <td align="center">
                            <a href="./?vista=editarUsuario&id=<?=$mat[$i]?>" class="text-primary"><i
