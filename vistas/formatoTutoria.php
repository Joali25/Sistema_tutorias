...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <strong>Formulario tutoría</strong>
    ...
    <div class="card-body">
        <div class="col-sm-6">
            <h5 class="card-title">¡Los campos con <span class="text-danger">*</span> son obligatorios!</h5>
                <form method="post" enctype="multipart/form-data" action="./?vista=guardarRespuestas">
                    <input type="hidden" name="id" id="id" value="<?=$obj->Id_tutoria?>">
                    <?php
                    $i=1;
                    $cant=count($campos);
                    if ( $cant > 0) {
                        foreach($campos as $camp) {?>
                            ...
                            <div class="form-group">
                                <label><?=$camp->Campo?> <span class="text-danger">*</span></label>
                                <input type="text" name="<?=$i?>" id="<?=$i?>" class="form-control" required>
                            </div>
                    <?php
                        $i=$i+1; 
                        }
